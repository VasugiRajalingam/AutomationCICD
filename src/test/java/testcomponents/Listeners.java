...
import reusablecomponents.ReportCreation;

import java.io.File;
import java.io.IOException;

public class Listeners extends BaseTest implements ITestListener {
    ExtentReports extentReport = ReportCreation.getExtentReport();
    ...
    public void onTestFailure(ITestResult result) {
        ...
        String path = null;
        try {
            path = String.valueOf(getScreenshot(result.getMethod().getMethodName(), driver));
        } catch (IOException e) {
